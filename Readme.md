...
Difficulty - The Model was not able to train the data as house sizes (thousands) were too large for the weights.
Resolution - Used Normalization to bring all values between -2 and 2.